...
<body>
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>
     ...
     <div class="page-container">
     	...
     	onclick="member_add('添加医生','editAdd?deid=0','380','580')" class="btn btn-primary radius">
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			<thead>
				<tr class="text-c">
					...
					<th width="80">挂号费</th>
					<th width="80">职业</th>
					<th width="80">网上可预约人数</th>
					<th width="80">现场可预约人数</th>
					<th width="">信息</th>
					<th width="80">状态</th>
					<th width="100">操作</th>
				</tr>
			...
			<tbody>
				<c:forEach items="${doctors }" var="d">
					...
					<td class="td-status">
					<c:choose>
						<c:when test="${d.doexist eq 1}"><span class="label label-success radius">已启用</span></c:when>
					...
					<td class="td-manage">
					<c:choose>
						<c:when test="${d.doexist eq 1}">
						<a style="text-decoration:none" onClick="drug_stop(this,${d.doid })" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a>
						</c:when>
						<c:otherwise>
						<a style="text-decoration:none" onClick="drug_start(this,${d.doid })" href="javascript:;" title="启用"><i class="Hui-iconfont">&#xe66b;</i></a>
						</c:otherwise>
					</c:choose>
					<a title="编辑" href="javascript:;" onclick="member_edit('编辑','doctors-edit?doid='+${d.doid },'380','580')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>  
				</td>
					</tr>
				</c:forEach>
			</tbody>
