...
<html>
  ...
  账号管理 <span class="c-gray en">&gt;</span>划价发药员列表 <a id="refresh" class="btn btn-success radius r" 
...
<div class="page-container">
	...
	onclick="member_add('添加发药员账号','tempAll?state=4','400','300')" class="btn btn-primary radius">
		<i class="Hui-iconfont">&#xe600;</i>添加划价发药员</a></span> </div>
	<div class="mt-20">
